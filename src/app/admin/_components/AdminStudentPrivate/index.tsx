"use client";
import { useStudentPrivateData } from "./useStudentPrivateData";
import StudentTable from "./StudentTable";
import StudentFormModal from "./StudentFormModal";
import StudentDetailModal from "./StudentDetailModal";
import AddSessionsModal from "./AddSessionsModal";

export default function AdminStudentPrivate({ branchId, branches, onBranchesChange }: {
   ...
   * this screen show every private student across all centers at once (with
  ...
  const hook = useStudentPrivateData({ branchId, branches, onBranchesChange });

...
const WA_MESSAGE = "Halo Admin Next Swimming School, saya ingin bertanya tentang program les renang. Bisa dibantu?";

export default function WAFloatingButton() {
  const [visible, setVisible] = useState(false);
  const [hovered, setHovered] = useState(false);

  // Muncul setelah 1.2 detik supaya tidak langsung mengganggu saat page load
  useEffect(() => {

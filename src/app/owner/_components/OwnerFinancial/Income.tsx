      ...
      <div className="bg-paper border border-line rounded-2xl p-4 space-y-3 shadow-xs">
        <div className="flex gap-2 flex-wrap">
          <div className="flex-1 min-w-48 relative">
            ...
            <input value={incomeSearch} onChange={e => setIncomeSearch(e.target.value)} placeholder={t("owner.financial.searchIncomePlaceholder")} className="w-full pl-9 pr-3 h-10 text-sm rounded-xl border border-line bg-paper text-ink focus:outline-none focus:border-ocean-500 transition" />
          </div>
        ...
        <div className="flex gap-2 flex-wrap items-center">
          ...
          <span className="text-xs font-semibold text-ink-mute ml-auto">{t("owner.financial.rowCount", { count: filteredIncome.length })}</span>
        </div>
      </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="h-9 border-b border-line bg-paper-deep text-[10px] uppercase font-bold text-ink-faint tracking-wider">
                    ...
                    <th className="text-left px-4 py-2">{t("owner.financial.colMember")}</th>
                    <th className="text-left px-4 py-2">{t("owner.financial.colClass")}</th>
                    <th className="text-left px-4 py-2">{t("owner.financial.colPeriod")}</th>
                    <th className="text-left px-4 py-2">{t("owner.financial.colType")}</th>
                    <th className="text-left px-4 py-2">{t("owner.financial.colMethod")}</th>
                    ...
                    <th className="text-left px-4 py-2">{t("owner.financial.colStatus")}</th>

...
export const keys = {
  ...
  ownerSignature: ()                                   => `owner/head_signature.png`,
  schoolLogo: (schoolId: string)                       => `schools/${schoolId}/logo.jpg`,
  schoolSignature: (schoolId: string, sigId: string)   => `schools/${schoolId}/signatures/${sigId}.png`,

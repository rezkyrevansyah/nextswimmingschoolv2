...
**Apa:** Data diri, rekening, QR, kata sandi.

**Yang dapat dilakukan:** menyunting nama, telepon, gender, tanggal lahir, bank; `is_profile_complete` dihitung ulang; **ganti kata sandi**; menampilkan QR; keluar.

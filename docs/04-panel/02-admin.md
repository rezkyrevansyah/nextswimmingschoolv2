...
**Yang dapat dilakukan:** satu kali tambah menyimpan bersama: data siswa, **harga paket + jumlah sesi** (bukan harga per pertemuan, FB-02), sisa sesi, jadwal, pelatih, lokasi atau pin; mengubah sisa sesi; menugaskan pelatih; menambah sesi paket; menghapus. Kelas privat **tidak** tampil di **Class**.
...
**Apa:** Antrian pengajuan Sick dan Izin. Tiga sub-tab. Rincian mesin: `docs/03-alur/03-absensi-izin-honor.md` bab 4.
...
**Dampak ke peran lain:** pelatih, siswa, staf mengajukan dari panel mereka; pengganti tampil di **Class Activity** dan jadwal Class pengganti; roster siswa mendapat baris Sick/Izin.

**Jangan:** mencampur tiga sub-tab jadi satu tabel. Jangan mengartikan Supported sebagai pengganti. Libur kelas bukan di sini.
...
| Leave Requests | — | Ajukan; jadwal pengganti otomatis | Sub-tab Staff (tanggal nanti); hari ini Bell saja | Ajukan; absensi otomatis | — | — |

...
| F-AKN-07 | Setiap akun yang dibuat wajib dapat QR plus `public_id` pada saat create. Permanen sampai akun dihapus. | US-04, US-12 |
| F-AKN-08 | Kotak pencarian bilah atas bukan pencarian global. | US-12 |
| F-AKN-09 | `public_id` = `NEXT.<3-digit>.<kode role>.<YY>`. Kode: OW AD MC CO ST SC SF. Staff = `SF`, bukan `ST`. Tampil di Profile. | US-12 |

...
1. Buat kelas: nama, hari dan jam (boleh berbeda per hari), kapasitas, harga bulanan atau per sesi, foto, lokasi di pusat atau eksternal (eksternal boleh pin sendiri).
2. Tugaskan pelatih kepala dan/atau asisten.

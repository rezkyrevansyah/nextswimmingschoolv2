...
Kalau diminta **buat proyek dari ulang:** 0 → 1 → 2 → seluruh `03-alur/` (01 sampai 05) → panel peran yang dikerjakan → `05-desain/`.

Kalau diminta **ubah satu layar:** baca alur terkait di `03-alur/`, lalu berkas panel itu. Jangan mengarang langkah yang bertentangan dengan alur.
